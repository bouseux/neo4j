 ...
 */
module.exports.setOptions = function(optionsNew) {
 ...
 *
 * @returns current server config: {{host: string, port: string, method: string, path: string, headers: {Accept: string, Content-Type: string}}}
 */
